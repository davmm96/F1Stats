...
class RaceRepository(
    ...
    override suspend fun getRaceDetails(id: Int): Result<List<RaceDetail>> {
    ...
    override suspend fun getCompletedRaces(): Result<List<Race>> {
    ...
    override suspend fun getRaceResult(id: Int): Result<List<RaceResult>> {
